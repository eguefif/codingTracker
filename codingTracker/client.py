...
class VimProcess:
    ...
    def get_pid(self) -> int:
        return re.search(r"\b[0-9]+", self.ps_entry).group()

    def get_language(self) -> str:
        vim_file = re.search(r"(?<=vim)\s*[a-zA-Z0-9.]+", self.ps_entry).group()
    ...
    def get_start_time(self):
        start_time = re.search(r"\b[0-9][0-9]:[0-9][0-9]\b", self.ps_entry).group()
